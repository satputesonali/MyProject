...
public class BookActivty1 extends AsyncTask<String, Void, String>  {

	private Context context;
	 
    public BookActivty1(Context context) {
	...
	protected String doInBackground(String... arg0) {
		// TODO Auto-generated method stub
	        ...
	        try {
	            ...
	            link = "http://192.168.43.243/NKOCETLibrary/Acc_reg.php" + data;
	        ...
	        if (jsonStr != null) {
	            try {
	                ...
	                if (query_result.equals("SUCCESS")) {
	                    Toast.makeText(context, "Book successfully stored.", Toast.LENGTH_SHORT).show();
	                      
	                } else if (query_result.equals("Accn_no")) {
	                       Toast.makeText(context, "ACC No Already Exist !", Toast.LENGTH_SHORT).show();
