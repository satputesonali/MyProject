...
public class BookSearchActivty2 extends AsyncTask<String, Void, String>  {

	private Context context;
	 
    public BookSearchActivty2(Context context) {
	...
	protected String doInBackground(String... arg0) {
		// TODO Auto-generated method stub
	        ...
	        try {
	            ...
	            link = "http://192.168.43.243/NKOCETLibrary/Book_Search2.php" + data;
	        ...
	        if (jsonStr != null) {
	            try {
	                ...
	                if (query_result.equals("SUCCESS")) {
	                    ...
	                    Intent i = new Intent(context, BookUpdateActivity.class);
	                    i.putExtras(b1);
